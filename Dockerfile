...
ARG BOT_OAUTH_ACCESS_TOKEN
ARG INCOMING_WEB_HOOK_URL
ARG OPENWEATHERMAP_API_KEY
ARG OPENWEATHERMAP_BASE_URL
ARG PORT
...
ENV BOT_OAUTH_ACCESS_TOKEN=${BOT_OAUTH_ACCESS_TOKEN}
ENV INCOMING_WEB_HOOK_URL=${INCOMING_WEB_HOOK_URL}
ENV OPENWEATHERMAP_API_KEY=${OPENWEATHERMAP_API_KEY}
ENV OPENWEATHERMAP_BASE_URL=${OPENWEATHERMAP_BASE_URL}
ENV PORT=${PORT}
